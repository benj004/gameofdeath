...
class GameOfLifeVisualizer:
    def __init__(self, width=80, height=60):
        ...
        self.ax.set_title('Conway\'s Game of Life - Click and drag to paint! Use toolbar to zoom/pan')
    ...
    def load_walker_attempt(self, event):
        ...
        self.im.set_array(self.game.grid)
        self.im.set_clim(vmin=0, vmax=1)
        self.ax.set_title('Conway\'s Game of Life - Walker Attempt (Experimental)')
        plt.draw()
        self.fig.canvas.flush_events()
